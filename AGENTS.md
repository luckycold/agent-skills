...
- Use `omarchy-dual-boot-secure-boot` for dual Omarchy Limine menus, SDDM after TPM unlock, the personal/work sbctl split, and installing third-party shell plugins onto a mounted peer OS home.
