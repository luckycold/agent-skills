...
5. Check the actual boot image as well as the installed configuration. Successful unsealing in a running session, even with the image's binaries, does not establish that measurements match during early boot.
